...
export default function ModbusConnectionCreator() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await ApiHandler.post("/api/v1/connections/create/modbus", formData);
      console.log("Response data from ModbusConnectionCreator: ", response);
